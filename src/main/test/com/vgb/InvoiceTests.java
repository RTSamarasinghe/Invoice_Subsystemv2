...
public class InvoiceTests {
    ...
    public void testInvoice01() {
        ...
        assertTrue(invoiceString.contains("Heavy Machinery") && invoiceString.contains("HM-2000"));
        assertTrue(invoiceString.contains("Construction Steel") && invoiceString.contains("kg"));
        assertTrue(invoiceString.contains("Maintenance Agreement"));
        
        // Check for financial values
        assertTrue(invoiceString.contains(String.format("%.2f", expectedSubtotal)) || invoiceString.contains(String.format("$%.2f", expectedSubtotal)));
        assertTrue( invoiceString.contains(String.format("%.2f", expectedTaxTotal)) || invoiceString.contains(String.format("$%.2f", expectedTaxTotal)));
        assertTrue(invoiceString.contains(String.format("%.2f", expectedGrandTotal)) || invoiceString.contains(String.format("$%.2f", expectedGrandTotal)));
    ...
    public void testInvoice02() {
        ...
        // Check for financial values
        // Account for different formatting possibilities
        assertTrue(invoiceString.contains(String.format("%.2f", expectedSubtotal)) || invoiceString.contains(String.format("$%.2f", expectedSubtotal)));
        assertTrue(invoiceString.contains(String.format("%.2f", expectedTaxTotal)) || invoiceString.contains(String.format("$%.2f", expectedTaxTotal)));
        assertTrue(invoiceString.contains(String.format("%.2f", expectedGrandTotal)) ||invoiceString.contains(String.format("$%.2f", expectedGrandTotal)));
    }
